...
public partial class PrimeVisionContext : DbContext
{
    ...
    public virtual DbSet<TCronologia> TCronologia { get; set; }
    ...
    public virtual DbSet<TRegista> TRegista { get; set; }
    ...
    public virtual DbSet<TUtente> TUtentes { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-QSKLA7L;Initial Catalog=PrimeVision;User ID=gabriele;Password=1234;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TCronologia>(entity =>
        {
        ...
        modelBuilder.Entity<TProfilo>(entity =>
        {
            entity.HasOne(d => d.Utente).WithMany(p => p.TProfilos).HasConstraintName("FK_T_Profilo_T_Utente");
        });
        ...
        modelBuilder.Entity<TRegista>(entity =>
        {
            entity.Property(e => e.Nazionalita).IsFixedLength();
        });
        ...
        modelBuilder.Entity<TUtente>(entity =>
        {
            entity.Property(e => e.Nazionalita).IsFixedLength();

            entity.HasOne(d => d.Piano).WithMany(p => p.TUtentes).HasConstraintName("FK_T_Utente_T_Piano");
        });
